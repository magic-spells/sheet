...
var SheetEngine = class extends EventEmitter {
	...
	*/
	constructor({ attraction = SPRING_PRESETS.entrance.attraction, friction = SPRING_PRESETS.entrance.friction } = {}) {
		super();
		const _ = this;
	...
	*/
	#syncBackdropProgress(p) {
		...
		_.#backdropProgress = dismissalZoneProgress(floor === void 0 ? _.#currentSize * flight : floor + (_.#currentSize - floor) * flight, _.#snaps[0]);
	}
	#emitChange() {
		const _ = this;
		_.emit("change", {
